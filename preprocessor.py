...
def preprocess(data,mobile="Android"):
    if ("AM" in data[0:19])or("PM" in data[0:19])or(data[15:17]=="pm")or(data[15:17]=="am")or(data[14:16]=="pm")or(data[14:16]=="am")or(data[20:22]=="PM")or(data[20:22]=="AM"):
        gh=12
        print("12")
        if mobile=="Android":
            mb="android"
            if ("AM" in data[0:19])or("PM" in data[0:19]):
